...
<body>
    <div style="max-width: 600px; margin: 0 auto; text-align: center;">
        ...
        <h1 style="font-size: 2em; font-weight: 900; margin-top: 1em; font-family: Inter;">Email Confirmation</h1>
        <p style="margin-top: 1em; font-family: Inter;">Click the button below to verify your email address:</p>
