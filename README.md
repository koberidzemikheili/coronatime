...
* <img src="readme/assets/npm.png" width="35" style="position: relative; top: 4px" /> *npm@9 and up*
...
```sh
git clone https://github.com/RedberryInternship/mikheil-koberidze-coronatime.git
```
...
#
### DrawSql
[![MySQL model](./readme/assets/drawsql.png)](https://drawsql.app/teams/kobe-1/diagrams/coronatime)